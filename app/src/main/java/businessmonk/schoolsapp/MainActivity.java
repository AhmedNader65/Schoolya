...
import businessmonk.schoolsapp.customfonts.TextViewSubtitle;
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
			...
			if(sonsNum==1) {
				...
				TextViewSubtitle kidName = (TextViewSubtitle) rootView.findViewById(R.id.kid_name);
				TextViewSubtitle kidClass = (TextViewSubtitle) rootView.findViewById(R.id.kid_class);
				...
				TextViewSubtitle kidName = (TextViewSubtitle) rootView.findViewById(R.id.kid_name);
				TextViewSubtitle kidName2 = (TextViewSubtitle) rootView.findViewById(R.id.kid2_name);
				TextViewSubtitle kidClass = (TextViewSubtitle) rootView.findViewById(R.id.kid_class);
				TextViewSubtitle kidClass2 = (TextViewSubtitle) rootView.findViewById(R.id.kid2_class);
				ArrayList<Student> sons =Parent.mySons;
				Student kid = sons.get(0);
				Glide.with(getContext()).load(kid.avatar).into(kidPic);
				kidName.setText(kid.name);
				...
				TextViewSubtitle kidName = (TextViewSubtitle) rootView.findViewById(R.id.kid_name);
				TextViewSubtitle kidName2 = (TextViewSubtitle) rootView.findViewById(R.id.kid2_name);
				TextViewSubtitle kidName3 = (TextViewSubtitle) rootView.findViewById(R.id.kid3_name);
				TextViewSubtitle kidClass = (TextViewSubtitle) rootView.findViewById(R.id.kid_class);
				TextViewSubtitle kidClass2 = (TextViewSubtitle) rootView.findViewById(R.id.kid2_class);
				TextViewSubtitle kidClass3 = (TextViewSubtitle) rootView.findViewById(R.id.kid3_class);
				ArrayList<Student> sons =Parent.mySons;
				Student kid = sons.get(0);
				Glide.with(getContext()).load(kid.avatar).into(kidPic);
				kidName.setText(kid.name);
				...
				TextViewSubtitle kidName2 = (TextViewSubtitle) rootView.findViewById(R.id.kid2_name);;
				TextViewSubtitle kidName3 = (TextViewSubtitle) rootView.findViewById(R.id.kid3_name);;
				TextViewSubtitle kidName4 = (TextViewSubtitle) rootView.findViewById(R.id.kid4_name);;
				TextViewSubtitle kidClass = (TextViewSubtitle) rootView.findViewById(R.id.kid_class);
				TextViewSubtitle kidClass2 = (TextViewSubtitle) rootView.findViewById(R.id.kid2_class);
				TextViewSubtitle kidClass3 = (TextViewSubtitle) rootView.findViewById(R.id.kid3_class);
				TextViewSubtitle kidClass4 = (TextViewSubtitle) rootView.findViewById(R.id.kid4_class);
				ArrayList<Student> sons =Parent.mySons;
				Student kid = sons.get(0);
				Glide.with(getContext()).load(kid.avatar).into(kidPic);
				kidName.setText(kid.name);
